...
```
g++ -std=c++17 -O3 main.cpp algorithms/Utils.cpp algorithms/LIS.cpp settings/Interface.cpp settings/settings.cpp SortController.cpp algorithms/Both_small.cpp algorithms/LIS_small.cpp algorithms/DirtyClean4.cpp algorithms/MergeSort.cpp algorithms/QuickSort.cpp algorithms/TimSort.cpp algorithms/OESM.cpp algorithms/Cook_Kim.cpp algorithms/Both2.cpp algorithms/Insertion.cpp -o main.exe
